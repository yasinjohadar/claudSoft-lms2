...
function switcherClick() {
    ...
    /* Mixed Layout Start (dark sidebar + light header/content) */
    let mixedBtn = document.querySelector('#switcher-mixed-theme');
    let mixedThemeVar = mixedBtn?.addEventListener('click', () => {
        mixedFn();
...
function mixedFn() {
    ...
    document.querySelector('#switcher-mixed-theme').checked = true;
    document.querySelector('#switcher-menu-dark').checked = true;
    document.querySelector('#switcher-header-light').checked = true;
    updateColors()
    localStorage.setItem('valexMixedTheme', true);
    localStorage.setItem('valexMenu', 'dark');
    localStorage.setItem('valexHeader', 'light');
    localStorage.removeItem('valexdarktheme');
    localStorage.removeItem('valexbgColor');
    ...
    localStorage.removeItem('valexbgwhite');
    localStorage.removeItem('valexMenubg');
    // لولا حذف هذه المفاتيح لأعادت localStorageBackup() في main.js فرض الوضع الداكن
    // عند تحميل الصفحة التالية، فيبدو الوضع المختلط وكأنه لا يعمل
    localStorage.removeItem('bodyBgRGB');
    localStorage.removeItem('bodylightRGB');
...
function checkOptions() {
    ...
    // mixed (dark sidebar + light header/content)
    if (localStorage.getItem('valexMixedTheme')) {
        let mixedRadio = document.querySelector('#switcher-mixed-theme');
        if (mixedRadio) {
