{{--
    لوحة «إعدادات العرض» للأدمن — نسخة مختصرة على نمط لوحة الطالب.

    الأصناف student-theme-* مشتركة بين البوابتين عمداً (نطاقها في custom.css
    هو :is(.student-portal, .admin-portal)) فلا تُكرَّر التنسيقات.

    ⚠ الحقول المخفية في آخر الملف إلزامية: سكربت الثيم
    public/assets/js/custom-switcher.min.js يستدعي addEventListener على هذه
    المعرّفات مباشرة، وغياب أيٍّ منها يرمي TypeError فيتوقف السكربت بالكامل
    ولا يعمل أي خيار في اللوحة. لا تحذفها عند تبسيط الواجهة.
--}}
<!-- Start Switcher -->
<div class="offcanvas offcanvas-end student-theme-switcher" tabindex="-1" id="switcher-canvas" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header student-theme-switcher__header border-0">
        <div>
            ...
            <p class="student-theme-switcher__subtitle mb-0">خصّص مظهر لوحة التحكم بسرعة</p>
        </div>
    ...
    <div class="offcanvas-body student-theme-switcher__body">
        ...
        <section class="student-theme-switcher__section">
            ...
            <div class="student-theme-switcher__grid student-theme-switcher__grid--3">
                <label class="student-theme-option">
                    ...
                    <span class="student-theme-option__icon"><i class="ri-sun-line"></i></span>
                ...
                <label class="student-theme-option">
                    ...
                    <span class="student-theme-option__icon"><i class="ri-moon-line"></i></span>
                ...
                <label class="student-theme-option">
                    ...
                    <span class="student-theme-option__icon"><i class="ri-contrast-2-line"></i></span>
        ...
        <section class="student-theme-switcher__section">
            ...
            <div class="student-theme-switcher__grid student-theme-switcher__grid--2">
                <label class="student-theme-option">
                    ...
                    <span class="student-theme-option__icon"><i class="ri-menu-line"></i></span>
                ...
                <label class="student-theme-option">
                    ...
                    <span class="student-theme-option__icon"><i class="ri-menu-fold-line"></i></span>
        ...
        <section class="student-theme-switcher__section">
            ...
            <div class="student-theme-switcher__grid student-theme-switcher__grid--2">
                <label class="student-theme-option student-theme-option--compact">
                    <input class="visually-hidden" type="radio" name="direction" id="switcher-rtl" checked>
                    <span class="student-theme-option__icon"><i class="ri-align-right"></i></span>
                    <span class="student-theme-option__text">عربي (RTL)</span>
                </label>
                <label class="student-theme-option student-theme-option--compact">
                    <input class="visually-hidden" type="radio" name="direction" id="switcher-ltr">
                    <span class="student-theme-option__icon"><i class="ri-align-left"></i></span>
                    <span class="student-theme-option__text">إنجليزي (LTR)</span>
                </label>
            </div>
        </section>

        {{-- خيارات مخفية — مطلوبة لسكربت الثيم، انظر التعليق أعلى الملف --}}
    ...
    <div class="student-theme-switcher__footer">
        <a href="javascript:void(0);" id="reset-all" class="btn btn-outline-danger w-100 rounded-pill">
            <i class="ri-refresh-line me-2"></i>إعادة الضبط الافتراضي
        </a>
    </div>
</div>
<!-- End Switcher -->
