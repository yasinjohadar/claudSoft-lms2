                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub {{ request()->routeIs('roles.*') || request()->routeIs('payment-methods.*') || request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.contact-settings.*') || request()->routeIs('admin.google-settings.*') || request()->routeIs('admin.meta-pixel-settings.*') || request()->routeIs('admin.settings.site.*') || request()->routeIs('admin.settings.payment-whatsapp-message.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') || (request()->routeIs('admin.whatsapp-*') || request()->routeIs('admin.flaxxa-wapi.*') || request()->routeIs('admin.evolution-api.*') || request()->routeIs('admin.telegram.*')) || request()->routeIs('admin.webhooks.*') || request()->routeIs('admin.n8n.*') || request()->routeIs('backups.*') || request()->routeIs('backup-*') || request()->routeIs('app-storage.*') || request()->routeIs('storage-disk-mappings.*') || request()->routeIs('admin.database-info.*') ? 'open active' : '' }}">
                            ...
                            <ul class="slide-menu child1 {{ request()->routeIs('roles.*') || request()->routeIs('payment-methods.*') || request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.contact-settings.*') || request()->routeIs('admin.google-settings.*') || request()->routeIs('admin.meta-pixel-settings.*') || request()->routeIs('admin.settings.site.*') || request()->routeIs('admin.settings.payment-whatsapp-message.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') || (request()->routeIs('admin.whatsapp-*') || request()->routeIs('admin.flaxxa-wapi.*') || request()->routeIs('admin.evolution-api.*') || request()->routeIs('admin.telegram.*')) || request()->routeIs('admin.webhooks.*') || request()->routeIs('admin.n8n.*') || request()->routeIs('backups.*') || request()->routeIs('backup-*') || request()->routeIs('app-storage.*') || request()->routeIs('storage-disk-mappings.*') || request()->routeIs('admin.database-info.*') ? 'active' : '' }}" style="{{ request()->routeIs('roles.*') || request()->routeIs('payment-methods.*') || request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.contact-settings.*') || request()->routeIs('admin.google-settings.*') || request()->routeIs('admin.meta-pixel-settings.*') || request()->routeIs('admin.settings.site.*') || request()->routeIs('admin.settings.payment-whatsapp-message.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') || (request()->routeIs('admin.whatsapp-*') || request()->routeIs('admin.flaxxa-wapi.*') || request()->routeIs('admin.evolution-api.*') || request()->routeIs('admin.telegram.*')) || request()->routeIs('admin.webhooks.*') || request()->routeIs('admin.n8n.*') || request()->routeIs('backups.*') || request()->routeIs('backup-*') || request()->routeIs('app-storage.*') || request()->routeIs('storage-disk-mappings.*') || request()->routeIs('admin.database-info.*') ? 'display: block;' : '' }}">
                                ...
                                <li class="slide has-sub {{ request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.bulk-emails.settings.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') ? 'open active' : '' }}">
                                    <a href="javascript:void(0);" class="side-menu__item">
                                        <i class="ri-mail-settings-line me-2"></i>إعدادات البريد
                                        <i class="fe fe-chevron-right side-menu__angle"></i>
                                    </a>
                                    <ul class="slide-menu child2 {{ request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.bulk-emails.settings.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}" style="{{ request()->routeIs('admin.settings.email.*') || request()->routeIs('admin.email-templates.*') || request()->routeIs('admin.bulk-emails.*') || request()->routeIs('admin.bulk-emails.settings.*') || request()->routeIs('admin.settings.password-reset-message.*') || request()->routeIs('admin.settings.account-created-message.*') ? 'display: block;' : '' }}">
                                        ...
                                        <li class="slide {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">
                                            <a href="{{ route('admin.settings.account-created-message.edit') }}" class="side-menu__item {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">بيانات الحساب عند الإنشاء</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="slide {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">
                                    <a href="{{ route('admin.settings.account-created-message.edit') }}" class="side-menu__item {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">
                                        <i class="ri-user-add-line me-2"></i>بيانات الحساب عند الإنشاء
                                    </a>
                                </li>
                                ...
                                @php
                                    $whatsappMenuActive = request()->routeIs('admin.whatsapp-*')
                                        ...
                                        || request()->routeIs('admin.settings.account-created-message.*');
                                    ...
                                    <ul class="slide-menu child2 {{ $whatsappMenuActive ? 'active' : '' }}" style="{{ $whatsappMenuActive ? 'display: block;' : '' }}">
                                        ...
                                        <li class="slide has-sub {{ $evolutionMenuActive ? 'open active' : '' }}">
                                            ...
                                            <ul class="slide-menu child2 {{ $evolutionMenuActive ? 'active' : '' }}" style="{{ $evolutionMenuActive ? 'display: block;' : '' }}">
                                                ...
                                                <li class="slide {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">
                                                    <a href="{{ route('admin.settings.account-created-message.edit') }}" class="side-menu__item {{ request()->routeIs('admin.settings.account-created-message.*') ? 'active' : '' }}">بيانات الحساب عند الإنشاء — واتساب/بريد</a>
                                                </li>
                                            </ul>
                                        </li>
