        ...
        <div class="container-fluid">
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in mb-4">
                ...
                <div class="card-body pt-3">
                    @if(($waContext['evolution_rotation_enabled'] ?? false))
                        <div class="alert alert-{{ ($waContext['rotation_pool_count'] ?? 0) >= 2 ? 'info' : 'warning' }} py-2 mb-3">
                            <i class="ri-shuffle-line me-1"></i>
                            @if(($waContext['rotation_pool_count'] ?? 0) >= 2)
                                التبديل نشط بين <strong>{{ $waContext['rotation_pool_count'] }}</strong> جلسة واتساب.
                            @else
