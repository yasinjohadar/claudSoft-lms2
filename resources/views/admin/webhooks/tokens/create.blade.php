    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إضافة توكن جديد</h5>
                    <nav>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card custom-card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.webhooks.tokens.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted">اسم وصفي للتوكن (مثل: WPForms Production Token)</small>
                                    </div>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="token" class="form-label">التوكن / المفتاح السري <span class="text-danger">*</span></label>
                                        ...
                                        @error('token')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">المفتاح السري المستخدم للتحقق من صحة الـ webhook (يتم تشفيره تلقائياً)</small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @error('allowed_ips')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">افصل بين الـ IPs بفواصل (اختياري)</small>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="form_types" 
                                               name="form_types" 
                                               value="{{ old('form_types') }}"
                                               placeholder='{"123": "enrollment", "456": "contact"}' 
                                               pattern=".*">
                                        @error('form_types')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                        <small class="form-text text-muted">JSON أو key:value مفصولة بفواصل (مثال: 123:enrollment, 456:contact)</small>
                                    </div>
