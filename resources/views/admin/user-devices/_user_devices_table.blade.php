            ...
            <tbody>
                @foreach($devices as $device)
                    ...
                    <tr class="ud-table-row">
                        ...
                        <td>
                            <div class="d-flex align-items-start gap-2 min-w-0" style="max-width: 280px;">
...
@else
    <div class="group-show-empty py-5">
        ...
        <p class="group-show-empty__desc mb-0">لا توجد أجهزة مسجّلة لهذا المستخدم أو لا تطابق الفلاتر الحالية.</p>
    </div>
@endif
