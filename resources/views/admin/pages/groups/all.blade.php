                ...
                <div class="card-body pt-3">
                    <form id="groups-filters-form" class="group-show-filters mb-0" onsubmit="return false;">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                <label class="form-label" for="filter-camp">النوع</label>
                                <select name="is_camp" id="filter-camp" class="form-select">
                                    <option value="">الكل</option>
                                    <option value="1" {{ request('is_camp') == '1' ? 'selected' : '' }}>معسكر</option>
                                    <option value="0" {{ request('is_camp') == '0' ? 'selected' : '' }}>مجموعة عادية</option>
                                </select>
                            </div>
                            <div class="col-md-3">
...
(function () {
    ...
    const baseUrl = @json(route('groups.all'));
    ...
    function getFilters() {
        ...
        return {
            ...
            is_camp: document.getElementById('filter-camp')?.value || '',
            sort: sort,
            order: order,
            page: currentPage,
        };
    ...
    function bindFilterEvents() {
        ...
        document.getElementById('filter-camp')?.addEventListener('change', function () {
            currentPage = 1;
            loadGroups(1);
        });
