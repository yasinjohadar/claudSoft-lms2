...
@section('content')
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="my-4 page-header-breadcrumb">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">المجموعات المدفوعة</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="group-show-hero dashboard-fade-in mb-4">
                <div class="row align-items-start g-3">
                    <div class="col-lg-7">
                        ...
                        <h2 class="group-show-hero__title mb-2">المجموعات المدفوعة</h2>
                        <p class="group-show-hero__desc mb-0">عرض وإدارة مجموعات المعسكر المدفوعة فقط، أعضاؤها، وحالتها من مكان واحد.</p>
                    </div>
                    <div class="col-lg-5">
            ...
            @include('admin.pages.groups.partials.paid-stats', [
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in mb-4">
                <div class="card-header border-0 pb-0">
                    <h4 class="card-title mb-1">تصفية المجموعات المدفوعة</h4>
...
(function () {
    ...
    const baseUrl = @json(route('groups.paid'));
