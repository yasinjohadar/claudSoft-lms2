        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">
                    <i class="fas fa-pen-square text-indigo me-2"></i>
                    سؤال ملء الفراغات
                </h5>
                <nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card custom-card mb-4">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-pen-square me-2 text-indigo"></i>نص السؤال مع الفراغات
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-info mb-3">
                                <i class="fas fa-info-circle me-2"></i>
                                استخدم <code>[[blank]]</code> أو <code>___</code> لتحديد مكان الفراغ في النص.
                                <br>
                                <small>مثال: عاصمة المملكة العربية السعودية هي [[blank]]</small>
                            </div>
                    ...
                    <div class="card custom-card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="card-title mb-0">
                                <i class="fas fa-check-circle me-2 text-success"></i>الإجابات الصحيحة
                            </div>
                            <button type="button" class="btn btn-sm btn-primary" id="add-answer-btn">
                                <i class="fas fa-plus me-1"></i>إضافة إجابة بديلة
                            </button>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-warning mb-3">
                                <i class="fas fa-lightbulb me-2"></i>
                                يمكنك إضافة عدة إجابات صحيحة مقبولة للفراغ الواحد.
                            </div>
