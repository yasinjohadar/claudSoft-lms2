    ...
    <div class="container-fluid">
        ...
        <div class="group-show-hero dashboard-fade-in mb-4">
            <div class="row align-items-start g-3">
                <div class="col-lg-8">
                    ...
                    <h2 class="group-show-hero__title mb-2">{{ $schedule->name }}</h2>
                    <p class="group-show-hero__desc mb-0">حدّث التكرار أو مكان التخزين أو أيام الاحتفاظ.</p>
                </div>
                <div class="col-lg-4">
        ...
        <div class="card custom-card group-show-members-card dashboard-fade-in mb-4">
            ...
            <div class="card-body pt-3">
                <form action="{{ route('backup-schedules.update', $schedule->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12" id="days_of_week_field" style="display: {{ $schedule->frequency === 'weekly' ? 'block' : 'none' }};">
