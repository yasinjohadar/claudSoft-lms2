...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            ...
            <div>
                <a href="{{ route('storage-disk-mappings.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form action="{{ route('storage-disk-mappings.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('storage-disk-mappings.index') }}" class="btn btn-secondary">
                                    إلغاء
                                </a>
                            </div>
                        </form>
