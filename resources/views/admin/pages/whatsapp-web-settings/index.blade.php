                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.whatsapp-web-settings.update') }}" method="POST" id="whatsapp-web-settings-form">
                            ...
                            <!-- Delay Settings moved to general WhatsApp settings -->
                            <div class="card border mb-4">
                                <div class="card-header bg-light">
                                    <h5 class="mb-0">
                                ...
                                <div class="card-body">
                                    <div class="alert alert-info mb-0">
                                        ...
                                        إعدادات الفواصل الزمنية <strong>عامة</strong> لجميع المزودين (WhatsApp Web، Evolution، Meta، إلخ).
                                        <div class="mt-2">
                                            <a href="{{ route('admin.whatsapp-settings.index') }}#delay-settings" class="btn btn-sm btn-primary">
                                                <i class="ri-settings-3-line me-1"></i>فتح إعدادات الفواصل في الإعدادات العامة
                                            </a>
                                        </div>
                                    </div>
                                </div>
