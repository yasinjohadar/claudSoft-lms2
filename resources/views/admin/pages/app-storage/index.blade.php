                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('app-storage.configs.edit', $config->id) }}" class="btn btn-sm btn-info">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-warning test-storage" data-config-id="{{ $config->id }}">
                                                        <i class="fas fa-vial"></i>
                                                    </button>
                                                    <form action="{{ route('app-storage.configs.destroy', $config->id) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه الإعدادات؟');">
                                                        @csrf
                                                        @method('DELETE')
