...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            ...
            <div>
                <a href="{{ route('app-storage.configs.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <form action="{{ route('app-storage.configs.store') }}" method="POST" id="storage-form">
                            @csrf
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('app-storage.configs.index') }}" class="btn btn-secondary">
                                    إلغاء
                                </a>
                            </div>
                        </form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const configTemplates = {
        ...
        `,
        'bunny': `
            <div class="mb-3"><label class="form-label">Storage Zone Name <span class="text-danger">*</span></label><input type="text" class="form-control" name="config[storage_zone]" required placeholder="اسم Storage Zone من Bunny"></div>
    ...
    if (testConnectionBtn && testConnectionResult) {
        testConnectionBtn.addEventListener('click', function() {
            ...
            // إرسال طلب AJAX
            fetch('{{ route("app-storage.configs.test-connection") }}', {
                method: 'POST',
                headers: {
