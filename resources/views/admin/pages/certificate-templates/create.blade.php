    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">إنشاء قالب شهادة جديد</h5>
                    <nav>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="html_content" class="form-control @error('html_content') is-invalid @enderror"
                                                  rows="15" style="font-family: monospace;">{{ old('html_content') }}</textarea>
                                        @error('html_content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="requires_completion"
                                                           id="requires_completion" value="1" {{ old('requires_completion') ? 'checked' : '' }}>
                                                ...
                                                <input type="number" name="min_completion_percentage" class="form-control mt-2"
                                                       placeholder="نسبة الإكمال %" value="{{ old('min_completion_percentage', 100) }}" min="0" max="100">
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="requires_attendance"
                                                           id="requires_attendance" value="1" {{ old('requires_attendance') ? 'checked' : '' }}>
                                                ...
                                                <input type="number" name="min_attendance_percentage" class="form-control mt-2"
                                                       placeholder="نسبة الحضور %" value="{{ old('min_attendance_percentage', 75) }}" min="0" max="100">
                                            </div>

                                            <div class="col-md-6 mb-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="requires_final_exam"
                                                           id="requires_final_exam" value="1" {{ old('requires_final_exam') ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="requires_final_exam">
                                                        يتطلب اختبار نهائي
                                                    </label>
                                                </div>
                                                <input type="number" name="min_final_exam_score" class="form-control mt-2"
                                                       placeholder="الدرجة المطلوبة" value="{{ old('min_final_exam_score', 60) }}" min="0" max="100">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="orientation" class="form-select">
                                            <option value="portrait" {{ old('orientation') == 'portrait' ? 'selected' : '' }}>عمودي (Portrait)</option>
                                            <option value="landscape" {{ old('orientation', 'landscape') == 'landscape' ? 'selected' : '' }}>أفقي (Landscape)</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="auto_issue"
                                                   id="auto_issue" value="1" {{ old('auto_issue') ? 'checked' : '' }}>
