...
<div class="main-content app-content">
    <div class="container-fluid">
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            ...
            <div>
                <a href="{{ route('backup-storage.create') }}" class="btn btn-primary btn-sm">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('backup-storage.edit', $config->id) }}" class="btn btn-sm btn-info">
                                                    ...
                                                    <form action="{{ route('backup-storage.destroy', $config->id) }}" method="POST" class="d-inline" onsubmit="return confirm('هل أنت متأكد من حذف هذه الإعدادات؟');">
                                                        @csrf
                                                        @method('DELETE')
