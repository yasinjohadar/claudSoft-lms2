...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div class="my-auto">
                <h5 class="page-title fs-21 mb-1">تعديل القالب</h5>
                <nav>
        ...
        <div class="card custom-card">
            <div class="card-body">
                <form action="{{ route('admin.flaxxa-wapi.templates.update', $template) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('admin.flaxxa-wapi.templates.index') }}" class="btn btn-secondary">رجوع</a>
                    </div>
                </form>
            </div>
        </div>
