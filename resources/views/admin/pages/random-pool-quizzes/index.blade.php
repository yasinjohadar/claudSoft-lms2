        ...
        <div class="container-fluid">
            ...
            <div class="my-4 page-header-breadcrumb quizzes-page-animate dashboard-fade-in">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">اختبارات بنك عشوائي</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="row align-items-start g-3">
                    <div class="col-lg-7">
                        <span class="group-show-hero__eyebrow">
                            <i class="fe fe-shuffle me-1"></i>
                            بنك عشوائي
                        </span>
                        <h2 class="group-show-hero__title mb-2">اختبارات بنك عشوائي</h2>
                        <p class="group-show-hero__desc mb-0">
                            إنشاء اختبارات تسحب أسئلة عشوائياً من بنك كبير (أسئلة مباشرة + مجموعات أسئلة).
                        </p>
                    </div>
                    <div class="col-lg-5">
                        <div class="group-show-actions">
                            <a href="{{ route('random-pool-quizzes.create') }}" class="group-show-action group-show-action--primary">
                                <span class="group-show-action__icon"><i class="fe fe-plus"></i></span>
                                <span class="group-show-action__text">إضافة اختبار بنك عشوائي</span>
                            </a>
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in quizzes-page-animate mb-4">
                ...
                <div class="card-body pt-3">
                    <form method="GET" action="{{ route('random-pool-quizzes.index') }}" id="filterForm" class="group-show-filters mb-0">
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in quizzes-page-animate">
                ...
                <div class="card-body pt-3" id="quizzesTableContainer">
                    @include('admin.pages.random-pool-quizzes._table', ['quizzes' => $quizzes])
                </div>
            </div>
