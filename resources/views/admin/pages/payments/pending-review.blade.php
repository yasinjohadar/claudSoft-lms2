        ...
        <div class="container-fluid">
            ...
            <div class="my-4 page-header-breadcrumb">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">بانتظار المراجعة</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="group-show-hero dashboard-fade-in mb-4">
                <div class="row align-items-start g-3">
                    <div class="col-lg-8">
                        ...
                        <h2 class="group-show-hero__title mb-2">دفعات بانتظار المراجعة</h2>
                        <p class="group-show-hero__desc mb-0">
                            طلبات الدفع المقدَّمة من الطلاب (بإيصال مرفق) وتنتظر موافقة أو رفض الأدمن.
                        </p>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in mb-4">
                <div class="card-header border-0 pb-0">
                    <h4 class="card-title mb-1">تصفية دفعات بانتظار المراجعة</h4>
                    <p class="fs-12 text-muted mb-0">جميع الفلاتر تعمل فوراً عبر AJAX.</p>
                </div>
                <div class="card-body pt-3">
                    <form method="GET" action="{{ route('payments.pending-review') }}" id="paymentsFilterForm" class="group-show-filters mb-0">
                        <input type="hidden" name="status" id="paymentsStatusHidden" value="pending_review">
