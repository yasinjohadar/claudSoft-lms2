        ...
        <div class="container-fluid">
            ...
            <div class="my-4 page-header-breadcrumb">
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">غير مسدد</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="group-show-hero dashboard-fade-in mb-4">
                <div class="row align-items-start g-3">
                    <div class="col-lg-8">
                        ...
                        <h2 class="group-show-hero__title mb-2">دفعات على فواتير غير مسددة</h2>
                        <p class="group-show-hero__desc mb-0">
                            الدفعات المرتبطة بفواتير لم تُسدَّد بالكامل بعد (لا تزال «غير مسددة»)، بصرف النظر عن حالة الدفعة نفسها.
                        </p>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in mb-4">
                <div class="card-header border-0 pb-0">
                    <h4 class="card-title mb-1">تصفية الفواتير غير المسددة</h4>
                ...
                <div class="card-body pt-3">
                    ...
                    <form method="GET" action="{{ route('payments.unpaid') }}" id="paymentsFilterForm" class="group-show-filters mb-0">
