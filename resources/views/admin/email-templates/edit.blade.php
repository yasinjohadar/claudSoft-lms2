                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                        <option value="registration_welcome" {{ old('type', $emailTemplate->type) == 'registration_welcome' ? 'selected' : '' }}>
                                            ترحيب بالتسجيل
                                        </option>
                                        <option value="enrollment_confirmation" {{ old('type', $emailTemplate->type) == 'enrollment_confirmation' ? 'selected' : '' }}>
                                            تأكيد التسجيل
                                        </option>
