        ...
        <div class="container-fluid">
                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-start gap-3">
                            ...
                            <div>
                                ...
                                <h2 class="group-show-hero__title mb-2">إضافة قالب بريد إلكتروني</h2>
                                <p class="group-show-hero__desc mb-0">أنشئ قالباً جديداً مع موضوع ومحتوى قابل للتخصيص بالمتغيرات.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="group-show-actions group-show-actions--single">
                            <a href="{{ route('admin.email-templates.index') }}" class="group-show-action group-show-action--info">
            ...
            <div class="card custom-card group-show-members-card dashboard-fade-in">
                <div class="card-header border-0 pb-0">
                    ...
                    <p class="fs-12 text-muted mb-0">أدخل الاسم والموضوع والمحتوى، ثم فعّل القالب عند الحاجة.</p>
                </div>
                    ...
                    <form action="{{ route('admin.email-templates.store') }}" method="POST" id="templateForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="type" class="form-select @error('type') is-invalid @enderror" required>
                                    <option value="registration_welcome" {{ old('type') == 'registration_welcome' ? 'selected' : '' }}>ترحيب بالتسجيل</option>
                                    <option value="enrollment_confirmation" {{ old('type') == 'enrollment_confirmation' ? 'selected' : '' }}>تأكيد التسجيل</option>
                        ...
                        <div class="admin-email-templates-page__form-actions d-flex flex-wrap gap-2 justify-content-md-end mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fe fe-save me-1"></i>حفظ القالب
                            </button>
                        </div>
                    </form>
                </div>
