...
<div class="main-content app-content student-work-form-page">
    <div class="container-fluid">
        ...
        <div class="group-show-hero dashboard-fade-in mb-4">
            <div class="row align-items-start g-3">
                <div class="col-lg-8">
                    ...
                    <h2 class="group-show-hero__title mb-2">إضافة عمل جديد</h2>
                    <p class="group-show-hero__desc mb-0">
                        أضف مشروعك أو عملك لبناء بورتفوليو احترافي يعرض مهاراتك.
                    </p>
                </div>
                <div class="col-lg-4">
        ...
        <form action="{{ route('student.works.store') }}" method="POST" enctype="multipart/form-data" id="student-work-form">
            @csrf
            <div class="row g-4">
                <div class="col-xl-8">
                ...
                <div class="col-xl-4">
                    @include('student.works.partials.form-sidebar', [
                        'work' => null,
                        'cancelUrl' => route('student.works.index'),
                        'submitLabel' => 'حفظ العمل',
                    ])
                </div>
            </div>
        </form>
...
@push('scripts')
    @include('student.works.partials.form-scripts', ['initialTags' => old('tags', [])])
@endpush
