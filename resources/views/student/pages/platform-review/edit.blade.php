    ...
    <div class="main-content app-content">
        <div class="container-fluid">
            ...
            <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                <div class="my-auto">
                    <h5 class="page-title fs-21 mb-1">تعديل تقييم المنصة</h5>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">تعديل التقييم</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card custom-card">
                        <div class="card-header">
                            <div class="card-title">
                                <i class="fas fa-edit me-2"></i>تعديل تقييمك
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- Status Alert -->
                            @if($review->is_active)
                                <div class="alert alert-warning mb-4">
                                    ...
                                    <strong>تنبيه:</strong> عند تعديل تقييمك، سيتم إرساله للمراجعة مرة أخرى قبل نشره.
                                </div>
                            @endif

                            <form action="{{ route('student.platform-review.update', $review->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="rating-input-page d-flex gap-2 justify-content-start">
                                        <input type="radio" id="star5" name="rating" value="5" required {{ old('rating', $review->rating) == '5' ? 'checked' : '' }}>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        minlength="10"
                                        maxlength="1000"
                                        placeholder="شاركنا تجربتك مع المنصة... ما الذي أعجبك؟ كيف ساعدتك الكورسات؟ ما هي المهارات التي اكتسبتها؟">{{ old('review_text', $review->review_text) }}</textarea>
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        <small class="form-text text-muted">
                                            الحد الأدنى 10 أحرف، الحد الأقصى 1000 حرف
                                        </small>
                                        <small class="form-text text-muted char-counter">
                                            <span id="char-count">{{ strlen(old('review_text', $review->review_text)) }}</span> / 1000
                                        </small>
                                    </div>
                                    @error('review_text')
                                        <div class="text-danger mt-1">{{ $message }}</div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                        maxlength="500"
                                        placeholder="نرحب باقتراحاتك لتحسين المنصة وتطويرها... ما الذي تود إضافته؟ كيف يمكننا تحسين تجربتك؟">{{ old('suggestion', $review->suggestion) }}</textarea>
                                    <small class="form-text text-muted">
                                ...
                                <div class="alert alert-info mb-4">
                                    ...
                                    <strong>ملاحظة:</strong> عند تعديل تقييمك، سيتم إرساله للمراجعة من قبل فريق الإدارة مرة أخرى قبل نشره.
                                </div>
