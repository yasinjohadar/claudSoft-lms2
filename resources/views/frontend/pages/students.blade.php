...
@php
    $pageTitle = 'الطلاب المميزون - ' . config('app.name');
    $pageDescription = 'تعرف على طلابنا المميزين في المنصة التعليمية. طلاب حققوا إنجازات رائعة وأكملوا دورات تدريبية متقدمة';
    $pageKeywords = 'الطلاب, طلاب مميزون, إنجازات, شهادات, تعليم';
    $canonicalUrl = route('frontend.students.index');
