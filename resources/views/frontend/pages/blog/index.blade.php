...
@php
    $pageTitle = 'المدونة - مقالات ودروس تعليمية | ' . config('app.name');
    $pageDescription = 'اطلع على أحدث المقالات والدروس التعليمية في مختلف المجالات. مدونة تعليمية شاملة بمحتوى عربي عالي الجودة';
    $pageKeywords = 'مدونة, مقالات, دروس تعليمية, تعليم, محتوى عربي, مقالات تقنية';
                            ...
                            <div class="featured-card">
                                <a href="{{ $featured->url }}" class="featured-link">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <p class="featured-excerpt">{{ Str::limit($featured->excerpt, 100) }}</p>
                                        <div class="featured-meta">
                                            <span class="meta-item">
                                                <i class="fa-solid fa-user"></i>
                                                {{ $featured->author?->name ?? 'المدير' }}
                                            </span>
                                            <span class="meta-item">
                        ...
                        <form action="{{ route('frontend.blog.search') }}" method="GET" class="search-form">
                            <div class="input-group">
                                <input type="text" name="q" class="form-control"
                                       placeholder="ابحث عن مقال..." required>
