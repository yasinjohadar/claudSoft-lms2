...
@section('meta_description', 'حجز موعد واستشارة تقنية مع ياسين جوخدار — استشارات في البرمجة، تطوير الويب، الموبايل واختيار المسار المهني.')
...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="glass-panel consultation-form-wrapper animate-on-scroll p-4 p-lg-5">
                        <form id="consultationForm" action="https://formspree.io/f/YOUR_FORM_ID" method="POST">
                            <input type="hidden" name="_subject" value="طلب حجز موعد استشارة تقنية - ياسين جوخدار">
                            <div class="row g-3">
                                <div class="col-md-6">
                        ...
                        <div class="accordion-item border rounded-3 mb-2 overflow-hidden">
                            <h3 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq1">
                                    كيف تتم الجلسة — أونلاين أم حضورياً؟
                                </button>
                            </h3>
                        ...
                        <div class="accordion-item border rounded-3 mb-2 overflow-hidden">
                            <h3 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq2">
                                    ما مدة الانتظار حتى تأكيد الموعد؟
                                </button>
                            </h3>
    ...
    <section class="cta-section">
        <div class="container animate-on-scroll">
            ...
            <a href="{{ route('frontend.contact') }}" class="btn-light-custom me-2">
                <i class="fas fa-paper-plane"></i> تواصل معنا
            </a>
            <a href="https://wa.me/963XXXXXXXXX" target="_blank" rel="noopener noreferrer" class="btn-primary-custom">
