...
use App\Http\Controllers\Admin\RandomPoolQuizController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('random-pool-quizzes', [RandomPoolQuizController::class, 'index'])->name('random-pool-quizzes.index');
        Route::get('random-pool-quizzes/create', [RandomPoolQuizController::class, 'create'])->name('random-pool-quizzes.create');
        Route::post('random-pool-quizzes', [RandomPoolQuizController::class, 'store'])->name('random-pool-quizzes.store');
        Route::get('random-pool-quizzes/{id}', [RandomPoolQuizController::class, 'show'])->name('random-pool-quizzes.show');
        Route::get('random-pool-quizzes/{id}/edit', [RandomPoolQuizController::class, 'edit'])->name('random-pool-quizzes.edit');
        Route::put('random-pool-quizzes/{id}', [RandomPoolQuizController::class, 'update'])->name('random-pool-quizzes.update');
        Route::delete('random-pool-quizzes/{id}', [RandomPoolQuizController::class, 'destroy'])->name('random-pool-quizzes.destroy');
        Route::post('random-pool-quizzes/{id}/toggle-publish', [RandomPoolQuizController::class, 'togglePublish'])->name('random-pool-quizzes.toggle-publish');
        Route::get('random-pool-quizzes/{id}/manage-questions', [RandomPoolQuizController::class, 'manageQuestions'])->name('random-pool-quizzes.manage-questions');
        Route::post('random-pool-quizzes/{id}/attach-question-pool', [RandomPoolQuizController::class, 'attachQuestionPool'])->name('random-pool-quizzes.attach-question-pool');
        Route::delete('random-pool-quizzes/{id}/detach-question-pool/{quizQuestionId}', [RandomPoolQuizController::class, 'detachQuestionPool'])->name('random-pool-quizzes.detach-question-pool');
        ...
        Route::prefix('docs')->name('admin.docs.')->group(function () {
            ...
            Route::prefix('ai-pages/batch')->name('ai-pages.batch.')->group(function () {
                ...
                // Literal segments must be declared before the {uuid} catch-all.
                Route::get('/history', [AIDocumentationBatchController::class, 'index'])->name('index');
                Route::get('/{uuid}', [AIDocumentationBatchController::class, 'show'])->name('show');
                Route::get('/{uuid}/status', [AIDocumentationBatchController::class, 'status'])->name('status');
                Route::post('/{uuid}/cancel', [AIDocumentationBatchController::class, 'cancel'])->name('cancel');
                Route::post('/{uuid}/restart', [AIDocumentationBatchController::class, 'restart'])->name('restart');
                Route::post('/{uuid}/resume-all', [AIDocumentationBatchController::class, 'resumeAll'])->name('resume-all');
                Route::post('/{uuid}/items/{item}/resume', [AIDocumentationBatchController::class, 'resumeItem'])->name('items.resume');
                Route::post('/{uuid}/items/{item}/release', [AIDocumentationBatchController::class, 'releaseItem'])->name('items.release');
            });
