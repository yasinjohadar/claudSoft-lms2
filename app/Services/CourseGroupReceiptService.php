...
class CourseGroupReceiptService
{
    ...
    public function store(UploadedFile $receipt, int $groupId, int $studentId): string
    {
        $directory = 'course-groups/payment-receipts/'.date('Y').'/'.$groupId.'/'.$studentId;
