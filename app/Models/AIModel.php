...
class AIModel extends Model
{
    ...
    /**
     * Get question generations using this model
     */
    ...
    /**
     * Get question solutions using this model
     */
    public function questionSolutions(): HasMany
    {
        return $this->hasMany(AIQuestionSolution::class, 'ai_model_id');
    }

    /**
     * Get student feedbacks using this model
     */
    public function studentFeedbacks(): HasMany
    {
        return $this->hasMany(AIStudentFeedback::class, 'ai_model_id');
    }
