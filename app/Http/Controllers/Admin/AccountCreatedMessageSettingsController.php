...
class AccountCreatedMessageSettingsController extends Controller
{
    ...
    public function edit(): View
    {
        ...
        return view('admin.pages.settings.account-created-message.edit', compact(
            'settings',
            'whatsappTemplates',
            'placeholders',
        ));
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        return redirect()
            ->route('admin.settings.account-created-message.edit')
            ->with('success', 'تم حفظ رسالة بيانات الحساب عند الإنشاء بنجاح.');
    }
